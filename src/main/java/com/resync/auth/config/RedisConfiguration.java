...
public class RedisConfiguration {
  ...
  public RedisConfiguration(
      @Value("${spring.redis.host}") String url,
  ...
  /**
   * Client Options
   * Reject requests when redis is in disconnected state and Redis will retry to
   * connect automatically when redis server is down
   *
